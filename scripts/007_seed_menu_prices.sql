-- Seed menu_prices from menu-data.ts
...
-- Seed site_content with default texts
INSERT INTO site_content (id, section, field_key, field_value) VALUES
('hero_title', 'hero', 'title', 'Take & Go Falkenberg'),
('hero_subtitle', 'hero', 'subtitle', 'Pizza & Burgare - Snabbt, Fräscht & Gott!'),
('hero_cta', 'hero', 'cta_text', 'Se Menyn'),
('about_title', 'about', 'title', 'Om Oss'),
('about_text', 'about', 'text', 'Vi på Take & Go Falkenberg brinner för god mat! Våra pizzor bakas med kärlek och de finaste ingredienserna. Välkommen att beställa och hämta - snabbt, fräscht och gott!'),
('contact_phone', 'contact', 'phone', '0346-XXX XX'),
('contact_email', 'contact', 'email', 'info@takeandgo.se'),
('contact_address', 'contact', 'address', 'Falkenberg, Sverige'),
('opening_weekdays', 'opening', 'weekdays', 'Mån-Fre: 10:00 - 21:00'),
('opening_weekends', 'opening', 'weekends', 'Lör-Sön: 11:00 - 21:00')
ON CONFLICT (id) DO UPDATE SET
